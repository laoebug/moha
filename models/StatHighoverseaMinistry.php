...
/**
 * This is the model class for table "stat_highoversea_ministry".
 *
 * @property integer $id
 ...
 */
class StatHighoverseaMinistry extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'stat_highoversea_ministry';
    }
    ...
    {
        return $this->hasMany(StatHighoverseaMinistryDetail::className(), ['stat_highoversea_ministry_id' => 'id']);
    }

    /**
     * @inheritdoc
     * @return StatHighoverseaMinistryQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new StatHighoverseaMinistryQuery(get_called_class());
    }
}
