...
/**
 * This is the model class for table "stat_contract".
 *
 * @property integer $id
 ...
 */
class StatContract extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasMany(StatContractDetail::className(), ['stat_contract_id' => 'id']);
    }

    /**
     * @inheritdoc
     * @return StatContractQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new StatContractQuery(get_called_class());
    }
}
