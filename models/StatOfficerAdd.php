...
/**
 * This is the model class for table "stat_officer_add".
 *
 * @property integer $id
 ...
 */
class StatOfficerAdd extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasMany(StatOfficerAddDetail::className(), ['stat_officer_add_id' => 'id']);
    }

    /**
     * @inheritdoc
     * @return StatOfficerAddQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new StatOfficerAddQuery(get_called_class());
    }
}
