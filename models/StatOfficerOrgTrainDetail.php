...
/**
 * This is the model class for table "stat_officer_org_train_detail".
 *
 * @property integer $id
 ...
 * @property integer $stat_officer_org_train_id
 * @property integer $organisation_id
 *
 * @property Organisation $organisation
 * @property StatOfficerOrgTrain $statOfficerOrgTrain
 */
class StatOfficerOrgTrainDetail extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'stat_officer_org_train_detail';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['stat_officer_org_train_id', 'organisation_id'], 'required','message'=>Yii::t('app','Please enter a value for') .Yii::t('app','{attribute}')],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'stat_officer_org_train_id' => Yii::t('app', 'Stat Officer Org Train ID'),
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getStatOfficerOrgTrain()
    {
        return $this->hasOne(StatOfficerOrgTrain::className(), ['id' => 'stat_officer_org_train_id']);
    }

    /**
     * @inheritdoc
     * @return StatOfficerOrgTrainDetailQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new StatOfficerOrgTrainDetailQuery(get_called_class());
    }
}
