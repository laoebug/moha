...
/**
 * This is the model class for table "stat_victorycoin_ministry_detail".
 *
 * @property integer $id
 ...
 * @property integer $stat_victorycoin_ministry_id
 * @property integer $award_id
 * @property integer $ministry_id
 *
 * @property Award $award
 * @property Ministry $ministry
 * @property StatVictorycoinMinistry $statVictorycoinMinistry
 */
class StatVictorycoinMinistryDetail extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'stat_victorycoin_ministry_detail';
    }
    ...
    {
        return [
            [['free1_personal', 'free1_team', 'free2_personal', 'free2_team', 'free3_personal', 'free3_team', 'revo1_personal', 'revo1_team', 'revo2_personal', 'revo2_team', 'revo3_personal', 'revo3_team', 'labo1_personal', 'labo1_team', 'labo2_personal', 'labo2_team', 'labo3_personal', 'labo3_team', 'deve1_personal', 'deve1_team', 'deve2_personal', 'deve2_team', 'deve3_personal', 'deve3_team', 'stat_victorycoin_ministry_id', 'award_id', 'ministry_id'], 'integer'],
            [['stat_victorycoin_ministry_id', 'award_id', 'ministry_id'], 'required', 'required','message'=>Yii::t('app','Please enter a value for') .Yii::t('app','{attribute}')],
            ...
            [['stat_victorycoin_ministry_id'], 'exist', 'skipOnError' => true, 'targetClass' => StatVictorycoinMinistry::className(), 'targetAttribute' => ['stat_victorycoin_ministry_id' => 'id']],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'stat_victorycoin_ministry_id' => Yii::t('app', 'Stat Victorycoin Ministry ID'),
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getStatVictorycoinMinistry()
    {
        return $this->hasOne(StatVictorycoinMinistry::className(), ['id' => 'stat_victorycoin_ministry_id']);
    }

    /**
     * @inheritdoc
     * @return StatVictorycoinMinistryDetailQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new StatVictorycoinMinistryDetailQuery(get_called_class());
    }
}
