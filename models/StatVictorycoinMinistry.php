...
/**
 * This is the model class for table "stat_victorycoin_ministry".
 *
 * @property integer $id
 ...
 */
class StatVictorycoinMinistry extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'stat_victorycoin_ministry';
    }
    ...
    {
        return $this->hasMany(StatVictorycoinMinistryDetail::className(), ['stat_victorycoin_ministry_id' => 'id']);
    }

    /**
     * @inheritdoc
     * @return StatVictorycoinMinistryQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new StatVictorycoinMinistryQuery(get_called_class());
    }
}
