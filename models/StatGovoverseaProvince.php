...
/**
 * This is the model class for table "stat_govoversea_province".
 *
 * @property integer $id
 ...
 */
class StatGovoverseaProvince extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'stat_govoversea_province';
    }
    ...
    {
        return $this->hasMany(StatGovoverseaProvinceDetail::className(), ['stat_govoversea_province_id' => 'id']);
    }

    /**
     * @inheritdoc
     * @return StatGovoverseaProvinceQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new StatGovoverseaProvinceQuery(get_called_class());
    }
}
