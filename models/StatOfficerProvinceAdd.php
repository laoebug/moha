...
/**
 * This is the model class for table "stat_officer_province_add".
 *
 * @property integer $id
 ...
 */
class StatOfficerProvinceAdd extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'stat_officer_province_add';
    }
    ...
    {
        return $this->hasMany(StatOfficerProvinceAddDetail::className(), ['stat_officer_province_add_id' => 'id']);
    }

    /**
     * @inheritdoc
     * @return StatOfficerProvinceAddQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new StatOfficerProvinceAddQuery(get_called_class());
    }
}
