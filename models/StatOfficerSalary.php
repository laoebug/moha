...
/**
 * This is the model class for table "stat_officer_salary".
 *
 * @property integer $id
 ...
 */
class StatOfficerSalary extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasMany(StatOfficerSalaryDetail::className(), ['stat_officer_salary_id' => 'id']);
    }

    /**
     * @inheritdoc
     * @return StatOfficerSalaryQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new StatOfficerSalaryQuery(get_called_class());
    }
}
