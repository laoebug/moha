...
class StatOfficerResignDetail extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['stat_officer_resign_id', 'ministry_group_id'], 'required'],
            [['stat_officer_resign_id', 'retire_total', 'bumnet_total', 'die_total', 'leave_total', 'fire_total', 'resign_total', 'lose_total', 'move_soe_total', 'moveto_ministry_total', 'movein_ministry_total', 'retire_women', 'bumnet_women', 'die_women', 'leave_women', 'fire_women', 'resign_women', 'lose_women', 'move_soe_women', 'moveto_ministry_women', 'movein_ministry_women', 'ministry_group_id'], 'integer'],
