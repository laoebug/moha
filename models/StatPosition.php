 ...
 */
class StatPosition extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * @inheritdoc
     * @return StatPositionQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new StatPositionQuery(get_called_class());
    }
}
