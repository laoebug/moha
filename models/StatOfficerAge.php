...
/**
 * This is the model class for table "stat_officer_age".
 *
 * @property integer $id
 ...
 */
class StatOfficerAge extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasMany(StatOfficerAgeDetail::className(), ['stat_officer_age_id' => 'id']);
    }

    /**
     * @inheritdoc
     * @return StatOfficerAgeQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new StatOfficerAgeQuery(get_called_class());
    }
}
