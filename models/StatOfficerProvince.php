 ...
 */
class StatOfficerProvince extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * @inheritdoc
     * @return StatOfficerProvinceQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new StatOfficerProvinceQuery(get_called_class());
    }
}
