...
/**
 * This is the model class for table "stat_population_movement".
 *
 * @property integer $id
 ...
 */
class StatPopulationMovement extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'stat_population_movement';
    }
    ...
    {
        return $this->hasMany(StatPopulationMovementDetail::className(), ['stat_population_movement_id' => 'id']);
    }

    /**
     * @inheritdoc
     * @return StatPopulationMovementQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new StatPopulationMovementQuery(get_called_class());
    }
}
