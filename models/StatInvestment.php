...
/**
 * This is the model class for table "stat_investment".
 *
 * @property integer $id
 ...
 */
class StatInvestment extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasMany(StatInvestmentDetail::className(), ['stat_investment_id' => 'id']);
    }
}
