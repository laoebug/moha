...
/**
 * This is the model class for table "stat_officer_province_train".
 *
 * @property integer $id
 ...
 */
class StatOfficerProvinceTrain extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'stat_officer_province_train';
    }
    ...
    {
        return $this->hasMany(StatOfficerProvinceTrainDetail::className(), ['stat_officer_province_train_id' => 'id']);
    }

    /**
     * @inheritdoc
     * @return StatOfficerProvinceTrainQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new StatOfficerProvinceTrainQuery(get_called_class());
    }
}
