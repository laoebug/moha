...
/**
 * This is the model class for table "stat_officer_ministry".
 *
 * @property integer $id
 ...
 */
class StatOfficerMinistry extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasMany(StatOfficerMinistryDetail::className(), ['stat_officer_ministry_id' => 'id']);
    }

    /**
     * @inheritdoc
     * @return StatOfficerMinistryQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new StatOfficerMinistryQuery(get_called_class());
    }
}
