 ...
 */
class StatLocalAdmin extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['last_update', 'user_id', 'saved', 'phiscal_year_id'], 'required', 'required','message'=>Yii::t('app','Please enter a value for') .Yii::t('app','{attribute}')],
            [['last_update'], 'safe'],
    ...
    /**
     * @inheritdoc
     * @return StatLocalAdminQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new StatLocalAdminQuery(get_called_class());
    }
}
