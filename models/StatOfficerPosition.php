...
/**
 * This is the model class for table "stat_officer_position".
 *
 * @property integer $id
 ...
 */
class StatOfficerPosition extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasMany(StatOfficerPositionDetail::className(), ['stat_officer_position_id' => 'id']);
    }

    /**
     * @inheritdoc
     * @return StatOfficerPositionQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new StatOfficerPositionQuery(get_called_class());
    }
}
