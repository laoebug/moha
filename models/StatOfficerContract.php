...
/**
 * This is the model class for table "stat_officer_contract".
 *
 * @property integer $id
 ...
 */
class StatOfficerContract extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasMany(StatOfficerContractDetail::className(), ['stat_officer_contract_id' => 'id']);
    }

    /**
     * @inheritdoc
     * @return StatOfficerContractQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new StatOfficerContractQuery(get_called_class());
    }
}
