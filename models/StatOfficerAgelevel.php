...
/**
 * This is the model class for table "stat_officer_agelevel".
 *
 * @property integer $id
 ...
 */
class StatOfficerAgelevel extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasMany(StatOfficerAgelevelDetail::className(), ['stat_officer_agelevel_id' => 'id']);
    }

    /**
     * @inheritdoc
     * @return StatOfficerAgelevelQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new StatOfficerAgelevelQuery(get_called_class());
    }
}
