...
/**
 * This is the model class for table "stat_explore".
 *
 * @property integer $id
 ...
 */
class StatExplore extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasMany(StatExploreDetail::className(), ['stat_explore_id' => 'id']);
    }

    /**
     * @inheritdoc
     * @return StatExploreQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new StatExploreQuery(get_called_class());
    }
}
