...
/**
 * This is the model class for table "stat_victoryoversea_province_detail".
 *
 * @property integer $id
 * @property integer $stat_victoryoversea_province_id
 ...
 * @property StatVictoryoverseaProvince $statVictoryoverseaProvince
 */
class StatVictoryoverseaProvinceDetail extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'stat_victoryoversea_province_detail';
    }
    ...
    {
        return [
            [['stat_victoryoversea_province_id', 'province_id', 'award_id'], 'required','message'=>Yii::t('app','Please enter a value for') .Yii::t('app','{attribute}')],
            ...
            [['stat_victoryoversea_province_id'], 'exist', 'skipOnError' => true, 'targetClass' => StatVictoryoverseaProvince::className(), 'targetAttribute' => ['stat_victoryoversea_province_id' => 'id']],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            'id' => Yii::t('app', 'ID'),
            'stat_victoryoversea_province_id' => Yii::t('app', 'Stat Victoryoversea Province ID'),
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getStatVictoryoverseaProvince()
    {
        return $this->hasOne(StatVictoryoverseaProvince::className(), ['id' => 'stat_victoryoversea_province_id']);
    }

    /**
     * @inheritdoc
     * @return StatVictoryoverseaProvinceDetailQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new StatVictoryoverseaProvinceDetailQuery(get_called_class());
    }
}
