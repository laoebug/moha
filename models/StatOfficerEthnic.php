...
/**
 * This is the model class for table "stat_officer_ethnic".
 *
 * @property integer $id
 ...
 */
class StatOfficerEthnic extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasMany(StatOfficerEthnicDetail::className(), ['stat_officer_ethnic_id' => 'id']);
    }

    /**
     * @inheritdoc
     * @return StatOfficerEthnicQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new StatOfficerEthnicQuery(get_called_class());
    }
}
