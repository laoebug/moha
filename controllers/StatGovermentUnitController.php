...
//        $fp = fopen($_FILES['file_upload']['tmp_name'], 'r');
//        $content = fread($fp, filesize($_FILES['file_upload']['tmp_name']));
        ...
        $model->deleted = 0;
//        $model->data = $content;
//        $model->name = $_FILES['file_upload']['name'];
//        $model->name = $menu->table_name . "_".date('Y_m')."";
