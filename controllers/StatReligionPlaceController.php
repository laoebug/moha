...
class StatReligionPlaceController extends Controller
{
    ...
    {
        $searchModel = new StatReligionPlaceSearch();
    ...
    /**
     * Displays a single StatReligionPlace model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new StatReligionPlace model.
    ...
    /**
     * Updates an existing StatReligionPlace model.
    ...
    /**
     * Deletes an existing StatReligionPlace model.
