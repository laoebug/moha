 ...
 */
class StatOfficerAddController extends BaseController
{
    /**
    ...
    public function actionEnquiry($year)
    {
        ...
        $models = StatOfficerAddDetail::find()->alias('d')
            ->select('d.*,g.name')
    ...
    public function actionUpload($year)
    {
        ...
        $menu = Menu::find()->where(['table_name' => 'stat_officer_add'])->one();
        if (!isset($menu)) {
