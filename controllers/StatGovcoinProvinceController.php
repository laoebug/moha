 ...
 */
class StatGovcoinProvinceController extends BaseController
{
    public $columns = [
    ...
    public function actionDelete()
    {
        ...
        if (isset($post['Model']))
            if (isset($post['Model']['id']))
                return StatGovcoinProvinceDetail::deleteAll(['id' => $post['Model']['id']]);
    }
    ...
    public function actionUpload($year)
    {
        ...
        $menu = Menu::find()->where(['table_name' => 'stat_govcoin_province'])->one();
        if (!isset($menu)) {
