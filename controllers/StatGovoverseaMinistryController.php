...
class StatGovoverseaMinistryController extends Controller
{
    ...
    public function actionDelete()
    {
        ...
        if (isset($post['Model']))
            if (isset($post['Model']['id']))
                return StatGovoverseaMinistryDetail::deleteAll(['id' => $post['Model']['id']]);
    }
    ...
    public function actionUpload($year)
    {
        ...
        $menu = Menu::find()->where(['table_name' => 'stat_govoversea_ministry'])->one();
        if (!isset($menu)) {
    ...
    public function actionGetreferences($year)
    {
        ...
        $files = Attachment::find()->alias('a')
            ->join('join', 'menu m', 'm.id = a.menu_id and m.table_name=:table', [
                ':table' => 'stat_govoversea_ministry'
            ])
