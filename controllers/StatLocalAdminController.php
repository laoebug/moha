...
class StatLocalAdminController extends Controller
{
    ...
    public function actionSave($year) {
        ...
        try{
            ...
            $detail->population_total = $post['StatLocalAdminDetail']['village_vice_total'];
            $detail->population_woman = $post['StatLocalAdminDetail']['village_vice_women'];
            $detail->village = $post['StatLocalAdminDetail']['village_vice_total'];
