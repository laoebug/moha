...
INSERT INTO `branch` (`id`, `code`, `name`, `deleted`, `address`, `tel`, `branch_group_id`, `position`) VALUES
(1, '', 'Central', '0', '', '', 0, 0),
(2, 'VTC', 'Vientiane', '0', '', '010', 0, 0);
...
INSERT INTO `branch_group` (`id`, `name`, `deleted`, `position`) VALUES
(1, 'ກຸ່ມເສດຖະກິດ', 0, 0),
(2, 'ກຸ່ມສັງຄົມວັດທະນະທຳ', 0, 0),
(3, 'ກຸ່ມອະທິປະໄຕ', 0, 0);
...
INSERT INTO `user` VALUES (1,'admin','admin','Administrator','','A','',NULL,0);
