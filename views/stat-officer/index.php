          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <td class="text-center"><input max="{{model.center_total}}" min="0" type="number" class="form-control" ng-model="model.center_women"></td>
              </tr>
              <tr>
                <td><?= Yii::t('app', 'Province') ?></td>
                <td class="text-center"><input min="0" type="number" class="form-control" ng-model="model.province_total"></td>
                <td class="text-center"><input max="{{model.province_total}}" min="0" type="number" class="form-control" ng-model="model.province_women"></td>
              </tr>
              <tr>
                <td><?= Yii::t('app', 'District') ?></td>
                <td class="text-center"><input min="0" type="number" class="form-control" ng-model="model.district_total"></td>
                <td class="text-center"><input max="{{model.district_total}}" min="0" type="number" class="form-control" ng-model="model.district_women"></td>
              </tr>
            </tbody>
          </table>
        </div>
