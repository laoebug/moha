      ...
      <div class="panel-body {{mode=='input'?'':'hidden'}}">
        ...
        <div class="col-sm-3">
          <div class="col-sm-12">
            ...
            <select class="form-control" ng-model="model.approver" ng-show="model.approverLevel.code == 'P'" ng-options="a.province.province_name for a in model.approverLevel.approvers" ng-change="inquiry()">
            </select>
          </div>
        </div>
        <div class="col-sm-2">
