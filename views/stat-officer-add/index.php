      ...
      <div class="panel-body {{mode=='input'?'':'hidden'}}">
        <div class="col-sm-12">
          <table class="table table-bordered table-hover">
            <thead>
              <tr>
                <th rowspan="2">ຊື່ພາກສ່ວນຕ່າງໆ</th>
                <th colspan="2">ເຂົ້າໃໝ່ 95%</th>
                <th colspan="2">ຍົກຍ້າຍມາຈາກກຳລັງປະກອບອາວຸດ</th>
                <th colspan="2">ຍົກຍ້າຍມາຈາກລັດວິສາຫະກິດ</th>
                <th colspan="2">ຍົກຍ້າຍມາຈາກກະຊວງ, ອົງການ, ແຂວງ</th>
                <th colspan="2">ຄວາມຕ້ອງການລັດຖະກອນໃໝ່</th>
              </tr>
            </thead>
            <tbody>
              <tr>
