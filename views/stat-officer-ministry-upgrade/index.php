...
$this->title = "ສະຖິຕິສັງລວມພະນັກງານຂັ້ນກະຊວງທີ່ໄປຍົກລະດັບຢູ່ພາຍໃນ ແລະ ຕ່າງປະເທດ";
// $this->params['breadcrumbs'][] = $this->title;
?>
<style rel="stylesheet" href="css/angular-datepicker.css"></style>
<div ng-app="mohaApp" ng-controller="officerMinistryUpgradeController">
  <!-- <div class="col-sm-12"> -->
      ...
      <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade" id="chart">
          <div class="card" ng-show="stat">
            ...
            <div class="row">
              <div class="col-sm-8">
                <canvas id="statbar" class="chart chart-bar" chart-data="stat.data" chart-labels="stat.labels" chart-series="stat.series" chart-colors="stat.colors" chart-options="options">
                </canvas>
              </div>
              <div class="col-sm-4">
                <canvas id="statpie" class="chart chart-pie" chart-data="stat.data" chart-labels="stat.labels" chart-series="stat.series" chart-colors="stat.colors">
                </canvas>
              </div>
            </div>
          </div>
...
<script type="text/javascript">
  ...
  Chart.defaults.global.defaultTitle = {
    display: true,
