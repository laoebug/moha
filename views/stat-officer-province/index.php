...
$this->title = "ສະຖິຕິລັດຖະກອນລວມຂອງບັນດາແຂວງ/ນະຄອນຫຼວງ";
// $this->params['breadcrumbs'][] = $this->title;
?>
<style rel="stylesheet" href="css/angular-datepicker.css"></style>
<div ng-app="mohaApp" ng-controller="officerProvinceController">
  <!-- <div class="col-sm-12"> -->
  ...
  <div class="col-sm-12" ng-show="models">
        ...
        <div class="tab-pane fade" id="chart">
          <div class="row">
            <div class="card">
              ...
              <canvas id="stat" class="chart chart-bar" chart-data="stat.data" chart-labels="stat.labels" chart-series="stat.series" chart-colors="stat.colors" </canvas> </div> </div> </div> <div class="tab-pane fade" id="reference">
                <div class="row">
                  <div class="col-sm-3">
                    <label>ເລກທີ</label>
    ...
    <script type="text/javascript">
      ...
      app.controller('officerProvinceController', function($scope, $http, $sce, $timeout) {
        $scope.url = 'index.php?r=stat-officer-province/';
        $scope.mode = 'read';
