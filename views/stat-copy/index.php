    ...
    <div class="col-sm-12">
        <div class="panel panel-primary" style="margin-top: 2em" ng-show="year">
            ...
            <div class="panel-body {{mode=='input'?'':'hidden'}}">
                ...
                <div class="col-sm-3">
                    <input class="form-control" ng-model="model.start_year" type="number" min="1900"
                           max="{{model.end_year}}">
                </div>
                <div class="col-sm-3">
                    <input class="form-control" ng-model="model.end_year" type="number" min="{{model.start_year}}"
                           max="2999">
                </div>
