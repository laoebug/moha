...
$this->title = "ສະຖິຕິລັດຖະກອນທີ່ເພີ່ມເຂົ້າ ແລະ ອອກທຸກຮູບການ ຂອງ ອົງການຈັດຕັ້ງຂັ້ນສູນກາງ";
      ...
      <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade" id="chart">
          <div class="card">
            ...
            <div class="row">
              <div class="col-sm-12">
                <canvas id="stat" class="chart chart-bar" chart-data="stat.data" chart-labels="stat.labels" chart-series="stat.series" chart-colors="stat.colors" chart-options="options">
                </canvas>
              </div>
            </div>
          </div>
