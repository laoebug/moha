      ...
      <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade" id="chart">
          <div class="card">
            ...
            <canvas id="stat" class="chart chart-bar" chart-data="stat.data" chart-labels="stat.labels" chart-series="stat.series" chart-colors="stat.colors" chart-options="options"></canvas>
          </div>
        </div>
