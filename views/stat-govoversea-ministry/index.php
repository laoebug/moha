...
$this->title = "ປະເພດຫຼຽນກາຕ່າງໆ ແລະ ໃບຍ້ອງຍໍລັດຖະບານ ສຳລັບຍ້ອງຍໍຕ່າງປະເທດຂອງບັນດາກະຊວງ, ອົງການ";
// $this->params['breadcrumbs'][] = $this->title;
?>
<style rel="stylesheet" href="css/angular-datepicker.css"></style>
<div ng-app="mohaApp" ng-controller="statGovoverseaMinistry">
  <!-- <div class="col-sm-12"> -->
...
<script type="text/javascript">
  ...
  app.controller('statGovoverseaMinistry', function($scope, $http, $sce, $timeout) {
    $scope.url = 'index.php?r=stat-govoversea-ministry/';
    $scope.mode = 'read';
    ...
    $scope.select = function(m) {
      ...
      for (var i in $scope.ministries) {
        ...
        if (ministry.id === $scope.model.ministry_id) {
