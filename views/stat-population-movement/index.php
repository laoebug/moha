        ...
        <div class="col-sm-12">
          <table class="table table-bordered">
            ...
            <tr>
              ...
              <td class="text-center" style="width: 10%"><input ng-model="model.married_local_foreigner" min="0" type="number" class="form-control"></td>
              <td class="text-center" style="width: 10%"><input ng-model="model.divorce"  type="number" class="form-control"></td>
              <td class="text-center" style="width: 10%"><input ng-model="model.divorce_local_foreigner"  type="number" class="form-control"></td>
            </tr>
          </table>
        </div>
    ...
    <div class="bs-component card">
      ...
      <div class="tab-content" id="myTabContent">
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <th class="text-center" rowspan="2">ຢ່າຮ້າງ ລາວ-ລາວ</th>
                  <th class="text-center" rowspan="2">ຢ່າຮ້າງ ລາວ-ຕ່າງປະເທດ</th>
        ...
        <div class="tab-pane fade" id="chart">
          ...
          <canvas id="stat" class="chart chart-bar" chart-data="stat.data" chart-labels="stat.labels" chart-series="stat.series" chart-colors="stat.colors" </canvas> </div> <div class="tab-pane fade" id="reference">
            <div class="row">
              <div class="col-sm-3">
                <label>ເລກທີ</label>
