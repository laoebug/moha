...
<div class="page-error">
      <h1><i class="fa fa-exclamation-circle"></i> <?php echo Yii::t("app","HTTP Error 401.2 - Unauthorized operation")?></h1>
      <p><?php echo Yii::t("app","You are not authorized to view this page due to invalid authentication")?></p>
