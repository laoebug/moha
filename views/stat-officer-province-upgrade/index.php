          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <td style="width: 12.5%"><input class="form-control" ng-model="model.bachelor_in_women" min="0" max="{{model.bachelor_in_total}}" type="number">
                </td>
                <td style="width: 12.5%"><input class="form-control" ng-model="model.bachelor_out_total" min="0" type="number"></td>
                <td style="width: 12.5%"><input class="form-control" ng-model="model.bachelor_out_women" min="0" max="{{model.bachelor_out_total}}" type="number">
                </td>
  ...
  <div class="col-sm-12" ng-show="models">
    <div class="bs-component card">
      ...
      <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade" id="chart">
          <div class="card" ng-show="stat">
            ...
            <div class="row">
              <div class="col-sm-8">
                <canvas id="statbar" class="chart chart-bar" chart-data="stat.data" chart-labels="stat.labels" chart-series="stat.series" chart-colors="stat.colors" chart-options="options" </canvas> </div> <div class="col-sm-4">
                  <canvas id="statpie" class="chart chart-pie" chart-data="stat.data" chart-labels="stat.labels" chart-series="stat.series" chart-colors="stat.colors" </canvas> </div> </div> </div> </div> <div class="tab-pane fade" id="reference">
                    <div class="row">
                      <div class="col-sm-3">
                        <label>ເລກທີ</label>
      ...
      <script type="text/javascript">
        ...
        app.controller('officerProvinceUpgradeController', function($scope, $http, $sce, $timeout) {
          $scope.url = 'index.php?r=stat-officer-province-upgrade/';
          $scope.mode = 'read';
