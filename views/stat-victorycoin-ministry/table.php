...
<div class="row">
    <div class="col-sm-12">
        <h3 class="title">ຕາຕະລາງສະຖິຕິປະເພດຫຼຽນໄຊຕ່າງໆ ທີ່ໄດ້ມອບໃຫ້ພາຍໃນຂອງບັນດາກະຊວງ ແລະ ອົງການທຽບເທົ່າອ້ອມຂ້າງສູນກາງ ປະຈຳປີ (<?= $year->year ?>)</h3>
        <table class="table table-bordered table-hover">
            <thead>
                <tr>
                    <th class="text-center" rowspan="4"><?= Yii::t('app', 'No.') ?></th>
                    <th class="text-center" rowspan="4" rowspan="2">ຊື່ກະຊວງ ແລະ ອົງການທຽບເທົ່າ</th>
